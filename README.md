...
__TS CORE__ — сайт для управления 5G/4G-подписчиками, построенный на Django. Он ориентирован на сетевых администраторов или инженеров телеком-операторов, которые настраивают параметры абонентов в мобильной сети.
...
<p align="center">
  <img src=".github/images/image_3.png" alt="Добавление нового абонента" title="Добавление нового абонента" width="500">
  <img src=".github/images/image_4.png" alt="Список абонентов" title="Список абонентов" width="500">
</p>
...
<p align="center">
  <img src=".github/images/image_1.png" alt="Регистрация пользователя" title="Регистрация пользователя" width="500">
  <img src=".github/images/image_2.png" alt="Профиль пользователя" title="Профиль пользователя" width="500">
</p>
...
## ⚙️ Установка и запуск проекта в режиме разработке
